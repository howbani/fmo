...
namespace FMO.Dataplane
{
    ...
    {
        public static int myNetWorkSize { get; set; }
        ...
        public static int UpdateFMOeveryXseconds
        {
            get
            {
                return 70;
        ...
        public static long NumberofDataPackets { get; set; }
        public static long NumberofUpdatePackets { get; set; }
        public static long NumberofDeliveredDataPacket { get; set; }
        ...
        public static double UpdatePacketLength = 1024;//bit
