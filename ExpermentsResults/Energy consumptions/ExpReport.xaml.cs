...
namespace FMO.ExpermentsResults.Energy_consumptions
{
    class ResultsObject
    {
        ...
        public double AverageOverheadTransmissions { get; set; }
    ...
    public partial class ExpReport : Window
    {
        ...
        public ExpReport(MainWindow _mianWind)
        {
            ...
            double avergaeOverhead = Convert.ToDouble(PublicParamerters.NumberofOverheadPackets) / NumberofDeliveredPacket;
            res.AverageOverheadTransmissions = avergaeOverhead;
            ...
            List.Add(new ValParPair() { Par = "Average Overhead Transmissions/path", Val = res.AverageOverheadTransmissions.ToString() });
            ...
            List.Add(new ValParPair() { Par = "Protocol", Val = "FMO" });
